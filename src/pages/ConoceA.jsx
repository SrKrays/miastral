...
export default function ConoceA() {
  return (
    <>
      ...
      {/* BANNER — mismo criterio que Bienestar/Diseño Humano: fondo semi-transparente
          que deja ver las partículas animadas (Starfield) que están detrás de toda la web. */}
      <section className="conoce-banner">
        <div className="conoce-banner-content">
          <h1 className="conoce-banner-title">Sobre mí</h1>
          <p className="conoce-banner-subtitle">Diseño Humano & Física Cuántica al servicio de tu autoconocimiento</p>
        </div>
      </section>
      ...
      <section className="conoce-bio">
        <div className="container-astral">
          <div className="conoce-bio-columns">
            <div className="conoce-bio-text-col">
